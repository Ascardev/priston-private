...
static int DrawFontBackToTexture2D( SFontImageChInfo *lpFontInfo, float fPos_x, float fPos_y, DWORD rgba, float fRatio )
{
	...
	psDraw2DImage(smMaterial[s_iFontImageMatNum].smTexture[0]->m_pTexture, tlVertex);
...
{
	s_iFontImageMatNum = CreateTextureMaterial( "image\\Bellatra\\FontImage.tga", NULL, 0, 0, SMMAT_BLEND_ALPHA);
