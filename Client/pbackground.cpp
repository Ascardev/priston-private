...
int smBACKGROUND::Init( int BgNum )
{
	...
	case FIELD_BACKIMAGE_RAIN:
		//비오는 하늘
		BGMatNum = lpMaterialGroup->CreateTextureMaterial( "sky\\RainSky.bmp" , 0 , FALSE , FALSE , SMMAT_BLEND_ALPHA );
	...
	case FIELD_BACKIMAGE_NIGHT:
		BGMatNum = lpMaterialGroup->CreateTextureMaterial( "sky\\nsky00.bmp" , 0 , FALSE , FALSE , SMMAT_BLEND_ALPHA );

		TexCount = 0;
		break;

	case FIELD_BACKIMAGE_DAY:
		BGMatNum = lpMaterialGroup->CreateTextureMaterial( "sky\\fsky00.bmp" , 0 , FALSE , FALSE , SMMAT_BLEND_ALPHA );
		TexCount = 0;
		break;

	case FIELD_BACKIMAGE_GLOWDAY:
		//많은하늘 ( 저녁 )
		BGMatNum = lpMaterialGroup->CreateTextureMaterial( "sky\\fgsky00.bmp" , 0 , FALSE , FALSE , SMMAT_BLEND_ALPHA );
	...
	case FIELD_BACKIMAGE_DESERT:
		//사막
		BGMatNum = lpMaterialGroup->CreateTextureMaterial( "sky\\dsky00.bmp" , 0 , FALSE , FALSE ,  SMMAT_BLEND_ALPHA );
	...
	case FIELD_BACKIMAGE_GLOWDESERT:
		//사막 ( 저녁 )
		BGMatNum = lpMaterialGroup->CreateTextureMaterial( "sky\\dgsky00.bmp" , 0 , FALSE , FALSE ,  SMMAT_BLEND_ALPHA );
	...
	case FIELD_BACKIMAGE_NIGHTDESERT:
		//사막 ( 밤 )
		BGMatNum = lpMaterialGroup->CreateTextureMaterial( "sky\\dnsky00.bmp" , 0 , FALSE , FALSE ,  SMMAT_BLEND_ALPHA );
		TexCount = 0;
		break;

	case FIELD_BACKIMAGE_RUIN1:
		BGMatNum = lpMaterialGroup->CreateTextureMaterial( "sky\\RuinSky2.bmp" , 0 , FALSE , FALSE ,  SMMAT_BLEND_ALPHA );
		lpMaterialGroup->AddTexture( BGMatNum , "sky\\fsky00.tga" );
		lpMaterialGroup->smMaterial[ BGMatNum ].TextureFormState[1]=smTEXSTATE_FS_SCROLL;
		lpMaterialGroup->smMaterial[ BGMatNum ].MapOpacity = 0;
		TexCount = 1;
	...
	case FIELD_BACKIMAGE_RUIN2:
		BGMatNum = lpMaterialGroup->CreateTextureMaterial( "sky\\RuinSky.bmp" , 0 , FALSE , FALSE ,  SMMAT_BLEND_ALPHA );
		lpMaterialGroup->AddTexture( BGMatNum , "sky\\fsky00.tga" );
		lpMaterialGroup->smMaterial[ BGMatNum ].TextureFormState[1]=smTEXSTATE_FS_SCROLL;
		lpMaterialGroup->smMaterial[ BGMatNum ].MapOpacity = 0;
		TexCount = 1;
	...
	case FIELD_BACKIMAGE_NIGHTRUIN1:
		BGMatNum = lpMaterialGroup->CreateTextureMaterial( "sky\\RuinSky2-n.bmp" , 0 , FALSE , FALSE , SMMAT_BLEND_ALPHA );
		lpMaterialGroup->AddTexture( BGMatNum , "sky\\fsky00.tga" );
		lpMaterialGroup->smMaterial[ BGMatNum ].TextureFormState[1]=smTEXSTATE_FS_SCROLL;
		lpMaterialGroup->smMaterial[ BGMatNum ].MapOpacity = 0;
		TexCount = 1;
	...
	case FIELD_BACKIMAGE_NIGHTRUIN2:
		BGMatNum = lpMaterialGroup->CreateTextureMaterial( "sky\\RuinNsky.bmp" , 0 , FALSE , FALSE ,  SMMAT_BLEND_ALPHA );
	...
	case FIELD_BACKIMAGE_NIGHTFALL:
		BGMatNum = lpMaterialGroup->CreateTextureMaterial( "sky\\forever-Nsky00.bmp" , 0 , FALSE , FALSE , SMMAT_BLEND_ALPHA );
		TexCount = 0;
		break;

	case FIELD_BACKIMAGE_DAYFALL:
		BGMatNum = lpMaterialGroup->CreateTextureMaterial( "sky\\forever-Fsky00.bmp" , 0 , FALSE , FALSE , SMMAT_BLEND_ALPHA );
	...
	case FIELD_BACKIMAGE_GLOWFALL:
		BGMatNum = lpMaterialGroup->CreateTextureMaterial( "sky\\forever-Gsky00.bmp" , 0 , FALSE , FALSE , SMMAT_BLEND_ALPHA );
		lpMaterialGroup->AddTexture( BGMatNum , "sky\\forever-Fsky00.tga" );
		lpMaterialGroup->smMaterial[ BGMatNum ].TextureFormState[1]=smTEXSTATE_FS_SCROLL;
		lpMaterialGroup->smMaterial[ BGMatNum ].MapOpacity = 0;
		TexCount = 1;
