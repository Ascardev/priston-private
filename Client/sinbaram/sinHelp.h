...
#define SIN_HELP_KIND_QUEST_BOX		30
...
public:
	...
	smTEXTUREHANDLE *lpHelpTitle;
	smTEXTUREHANDLE *lpChangeJobTitle;
	smTEXTUREHANDLE *lpHelpOk;
	smTEXTUREHANDLE *lpSodMenu;
	smTEXTUREHANDLE *lpSodLine;
	smTEXTUREHANDLE *lpSodJobFace[8];
public:
	int					ScrollLineCount;
	int					NPCTeleportFlag;
	int	NPCFlag;
public:
	...
	void KeyDown(); 
	int sinShowHelp(int Kind , int PosiX , int PosiY , int SizeW , int SizeH , DWORD BackColor,char *File,int NPCNum = 0);
