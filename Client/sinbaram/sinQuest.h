...
#define MONSTER_HEAD_CUTTER			3 // 침숲却
...
//신규 퀘스트 몬스터 추가 
#define MONSTER_HOPY                41 //뗌실艱
#define MONSTER_RABIE               42 //稿襤
#define MONSTER_NORTHGOBLIN         43 //앵침艱
#define MONSTER_HOBGOBLIN           44 //침艱깡
#define MONSTER_CORRUPT             45 //행太胎
...
#define MONSTER_ZOBI				50 //쉘暇
#define MONSTER_LEECH				51 //흙뒈질
#define MONSTER_OASIS				52 //쫄碌밍膠
#define MONSTER_DUN2				53 //뒈인2꿔밍膠
#define MONSTER_DARKNESS			54 //갠붚加등밍膠
#define MONSTER_DUN5				55 //쁩폭凱췰2꿔
#define MONSTER_IRON2				56 //屆쨌2돨밍膠
#define MONSTER_BABEL				57 //것깎檢
...
int DeleteQuestItem(DWORD CODE,int Kind = 0);
...
int sinSetQuestTimer(DWORD dwCode, int UseTime=0 , int CheckTime=0);
