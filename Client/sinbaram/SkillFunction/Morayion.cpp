...
DWORD sinNotToggleSkill_CODE[][5] =
{
	...
	{SKILL_ZENITH				,0										},
	{SKILL_WINDY				,0										},
	{SKILL_H_SONIC				,0										}, //快速打击
	{SKILL_P_ENHENCE			,0										}, //战神祝福
	{SKILL_AMPLIFIED			,0										}, //潜能激发
	{SKILL_HOLY_REFLECTION		,0										}, //圣光法阵//灵魂
	...
	{SKILL_DISTORTION			,0										},
	{SKILL_B_KRISHNA			,0										},//天女散花
	{SKILL_MAGNETIC_SPHERE		,0										},
	{SKILL_METAL_GOLEM			,0										},
	{SKILL_BERSERKER			,0										},//疯狂怒吼
	{SKILL_B_BERSERKER			,0										},//众神之怒
	{SKILL_ASSASSIN_EYE			,0										},
	{SKILL_VAGUE				,0										},
	{SKILL_RECALL_WOLVERIN		,0										},
	{SKILL_TALARIA				,0										},//轻舞飞扬
	{SKILL_S_ARCUDA				,0										},//笨笨熊
	{SKILL_ALAS					,0										},
	{SKILL_INPES				,0										},
	{SKILL_BLIND				,0										},
...
int F_Silraphim()
{
	sinUseManaStamina(pUseSkill); // 使用魔法耐力
	return TRUE;
}
// 缩小之术
int F_V_Tenus()
