...
public:
	...
	smTEXTUREHANDLE *lpRegiBox[5];
	smTEXTUREHANDLE *lpChangeArrow[2];
	smTEXTUREHANDLE *lpSelectArrow[2];
	smTEXTUREHANDLE *lpStatusPoint[2];
...
public:
	...
	void DrawCharText();
	void CheckLevel();
	void BackUpsinCharState(Unit *pChar);
	int sinGetNowExp();
	int sinGetNextExp();
