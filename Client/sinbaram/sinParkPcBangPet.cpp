...
{
	MatPcBangPetImage[0] = CreateTextureMaterial("Effect\\PcBangPet\\Pet_Phoenimin\\Pet_terry01.TGA", 0, 0, 0, SMMAT_BLEND_ALPHA);
	MatPcBangPetImage[1] = CreateTextureMaterial("Effect\\PcBangPet\\Pet_Phoenimin\\Pet_terry01.TGA", 0, 0, 0, SMMAT_BLEND_ALPHA);
	MatPcBangPetImage[2] = CreateTextureMaterial("Effect\\PcBangPet\\Pet_Phoenimin\\Pet_terry01.TGA", 0, 0, 0, SMMAT_BLEND_ALPHA);
	MatPcBangPetImage[3] = CreateTextureMaterial("Effect\\PcBangPet\\Pet_Phoenimin\\Pet_terry01.TGA", 0, 0, 0, SMMAT_BLEND_ALPHA);
}
