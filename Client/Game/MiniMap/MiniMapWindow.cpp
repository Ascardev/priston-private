...
namespace MINIMAP
{
	...
	void Window::RenderMap(Point3D sUserPosition)
	{
	...
	void Window::RenderUser(Point3D sUserAngle)
	{
		//Angle of User Point
	...
	BOOL Window::RenderNPC(Unit * pcUnit, Point3D sUserPosition, int iSize)
	{
	...
	BOOL Window::RenderPlayer(Unit * pcUnit, Point3D sUserPosition, int iUserClanID, int iSize)
	{
	...
	BOOL Window::RenderParty(Point3D sUserPosition, int iUserID, int iSize)
	{
	...
	void Window::LoadMiniMap(int iIndex, BaseMap * pcMap, smSTAGE3D * pcStage)
	{
	...
	void Window::DrawMinimap(MiniMapData * psMap, int iX, int iY, int iSize)
	{
	...
	Point2D Window::GetMinimapPositionFromCenter(Point3D sCenterPosition, Point3D sObjectPosition, int iWidthPoint, int iHeightPoint, int iSize)
	{
