...
namespace UI
{
	...
	void InputField::OnMouseMove(INPUTS::LPMOUSE pcMouse, int iX, int iY, int iWidth, int iHeight, int iSourceX, int iSourceY)
	{
		if (!IsOpen() || IsEnjoin())
			return;
		//Text Selected
	...
	BOOL InputField::OnMouseClick(INPUTS::LPMOUSE pcMouse, int iX, int iY, int iWidth, int iHeight, int iSourceX, int iSourceY)
	{
		if (!IsOpen() || IsEnjoin())
			return FALSE;
	...
	BOOL InputField::OnMouseScroll(INPUTS::LPMOUSE pcMouse, int iX, int iY, int iWidth, int iHeight, int iSourceX, int iSourceY)
	{
		if (!IsOpen() || IsEnjoin())
			return FALSE;
	...
	BOOL InputField::OnKeyPress(INPUTS::LPKEYBOARD pcKeyboard)
	{
		if (!IsOpen() || IsEnjoin())
			return FALSE;
	...
	BOOL InputField::OnKeyChar(INPUTS::LPKEYBOARD pcKeyboard)
	{
		if (!IsOpen() || IsEnjoin())
			return FALSE;
	...
	void InputField::AddInput(std::string str)
	{
		...
		if (m_bRegex)
		{
			...
			std::regex_match(str, e) ? str = str : str = "";
		}
