...
namespace UI
{
	...
	BOOL List::OnMouseClick(class INPUTS::Mouse *pcMouse, int iX, int iY, int iWidth, int iHeight, int iSourceX, int iSourceY)
	{
		BOOL bRet = FALSE;
	...
	BOOL List::OnMouseScroll(class INPUTS::Mouse *pcMouse, int iX, int iY, int iWidth, int iHeight, int iSourceX, int iSourceY)
	{
		if (!IsOpen() || IsLinkObject())
			return FALSE;
	...
	void List::OnMouseMove(class INPUTS::Mouse *pcMouse, int iX, int iY, int iWidth, int iHeight, int iSourceX, int iSourceY)
	{
		if (!IsOpen() || IsLinkObject())
			return;
	...
	BOOL List::OnKeyChar(class INPUTS::KeyBoard *pcKeyboard)
	{
		if (!IsOpen() || IsLinkObject())
			return FALSE;
	...
	BOOL List::OnKeyPress(class INPUTS::KeyBoard *pcKeyboard)
	{
		if (!IsOpen() || IsLinkObject())
			return FALSE;
