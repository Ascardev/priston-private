...
{
	LUAVISUALTYPE_None,
	LUAVISUALTYPE_Billboard,
	LUAVISUALTYPE_BillboardRotation,
	LUAVISUALTYPE_BillboardHorizontal,
	LUAVISUALTYPE_BillboardHorizontalRotation,
	LUAVISUALTYPE_BillboardVertical,
	LUAVISUALTYPE_BillboardVerticalRotation,
};
...
namespace LUA
{
	...
	public:
		...
		ELuaType GetType() { return m_eType; }
		ELuaVisualType GetVisualType() { return m_eVisualType; }

		EBlendType GetSourceBlendMode() { return m_eSourceBlendMode; }

		void AddLuaModifierGroup(ModifierGroup *pcLuaModifierGroup);
		ModifierGroup * GetLuaModifierGroup(ELuaModifierGroupType eType);
	protected:
	...
	protected:
		...
		std::vector<Event*> m_vLuaEvents;
		std::vector<ModifierGroup *> m_vLuaModifierGroups;
