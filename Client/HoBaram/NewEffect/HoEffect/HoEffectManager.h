...
public:
	...
	void	Init(Unit *pChar, HoEffectGroup *effectGroup, float endTime, float height = 0.f);
	void	UpdateView(int x, int y, int z, int ax, int ay, int az);
...
public:
	...
	void	Init(Unit *Char1, Unit *Char2, const std::string &textureName, int textureCount, float aniDelayTime);
	void	Init(HoEffectGroup *currentEffectGroup, HoEffectGroup *destEffectGroup);
	void	Init(Unit *char1, Unit *char2, int partID1, int partID2);
};
...
public:
	...
	void	UpdateView(int x, int y, int z, int ax, int ay, int az);
	void	Main(float elapsedTime);
	void	Init(Unit *pChar, const std::string &fileName, float endTime);
};
...
public:
	...
	void	UpdateView(int x, int y, int z, int ax, int ay, int az);
	void	Main(float elapsedTime);
	void	Init(Unit *pChar, float endTime, float attackTime);
};
...
public:
	...
	void	UpdateView(int x, int y, int z, int ax, int ay, int az);
	void	Main(float elapsedTime);
	void	Init(Unit *pChar, float endTime, float attackTime,int Kind);
	void    Process();
...
public:
	...
	bool	SetMaintainEffect(int code, Unit *pAttachChar, float time);
	bool	StopMaintainEffect(int code, Unit *pAttachChar,int iHead);
	void	Clear();
	BOOL    GetSkillCode(Unit *pChar, int code);
};
...
public:
	...
	void Init(Unit *pChar,HoEffectGroup *effectGroup,int iHead);
	void UpdateView(int x,int y,int z,int ax,int ay,int az);
	void Main(float elapsed);
};
