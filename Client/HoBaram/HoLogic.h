...
public:
	...
	int Draw(int x, int y, int z, int ax, int ay, int az);
	int Main();
	int Start(int x, int y, int z, int shieldType, int angle, int circleRadius, Unit *character);
...
public:
	...
	int Start(int x, int y, int z, int sw, int aniType = ANI_ONE, Unit *character = NULL);
};
...
public:
	int Draw(int x, int y, int z, int ax, int ay, int az);
	int Main();
	int Start(int worldX, int worldY, int worldZ, Unit *character);
};
