...
//	int cosX,cosY,sinX,sinY;
	...
	case SMPARTICLETYPE_BLOOD2:
		...
		{
			auto sPosition = GetMoveLocation(0, 0, -fONE * 8, angX, angY, 0);

			DispPosi.x += sPosition.iX;
			DispPosi.y += sPosition.iY;
			DispPosi.z += sPosition.iZ;
		}

		{
			auto sPosition = GetMoveLocation(0, 0, 128 * 256, angX, angY, 0);

			MovePosi.x = sPosition.iX;
			MovePosi.y = sPosition.iY;
			MovePosi.z = sPosition.iZ;
		}
