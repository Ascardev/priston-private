...
#define FREE_TRADECHAT			(SERVERCHAT->bFreeTradeChat)
...
public:
	CServerChat();
	virtual ~CServerChat();
	void SendDebugChat(User * pcUser, EChatColor eColor, const char * pszFormat, ...);
	...
	void SendChatAllUsersInClan(User * pcUser, EChatColor eColor, const char * pszFormat, ...);
	void SendChat(User * pcUser, EChatColor eColor, const char * pszText);
	void SendChatEx(User * pcUser, EChatColor eColor, const char * pszFormat, ...);
	void SendPersonalShopChat(User * pcUser, DWORD dwObjectID, const char * pszFormat, ...);
	void SendUserBoxChat(User * pcUser, DWORD dwObjectID, const char * pszFormat, ...);
	...
	void SendChatSpyMember(User * pcUser, void * pPacket);
	void SendChatTrade(User * pcUser, std::string strMessage);
